...
struct enactor_t : gunrock::enactor_t<problem_t> {
  ...
  void loop(gcuda::multi_context_t& context) override {
	gunrock::util::timer_t loop_timer;
	loop_timer.begin();
    // Data slice
	...
	auto elapsed = loop_timer.end();
	// std::cout << E->get_input_frontier()->get_number_of_elements() << ",";
	std::cout << E->get_output_frontier()->get_number_of_elements() << ",";	
	std::cout << (float)elapsed << "," << iteration << std::endl;
  }
